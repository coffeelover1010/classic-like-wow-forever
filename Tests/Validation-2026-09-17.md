...
Result: **15 behavioral scenarios passed**, plus Lua 5.1 compilation/execution of all **28 TOC files**, and an inventory check covering every configured artwork path.
...
- The package builder validated **33 allowlisted files**, ZIP CRCs and byte-for-byte payload equality.

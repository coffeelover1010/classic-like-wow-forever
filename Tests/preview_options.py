...
def render(output, scenario):
    ...
    canvas = Image.new("RGBA", (700, 870), (15, 14, 12, 255))
    ...
    result = Image.new("RGB", (748, 948), (29, 28, 25))
    result.paste(canvas.convert("RGB"), (24, 24))
    draw = ImageDraw.Draw(result)
    draw.text((24, 916), "Offline layout preview / approximate fonts / not an in-game screenshot",
